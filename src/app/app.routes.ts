...
import { KPIEvaluationFactorScoringMain } from './pages/KPITech/kpievaluation-factor-scoring/kpievaluation-factor-scoring-main.component';
...
import { ContractContractTransferReviewBgdComponent } from './pages/hrm/contract-transfer-review/contract-contract-transfer-review-bgd/contract-contract-transfer-review-bgd.component';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'contract-transfer-review-tbp', component: ContractTransferReviewTbpComponent, canActivate: [authGuard] },
      { path: 'contract-transfer-review-bgd', component: ContractTransferReviewBgdComponent, canActivate: [authGuard] },
