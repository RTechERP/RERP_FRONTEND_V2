...
export class LessonViewComponent implements OnChanges, OnInit, OnDestroy {
  ...
  onPlayerReady(api: VgApiService) {
    this.vgApi = api;
    this.applyPlaybackRate(this.selectedPlaybackRate);
  ...
  applyPlaybackRate(rate: number): void {
    ...
    const video = this.vgApi?.getDefaultMedia()?.elem as HTMLVideoElement | undefined;
    if (video) {
