...
export class BillExportSyntheticComponent implements OnInit, AfterViewInit {
  ...
  loadDataBillExportSynthetic() {
    ...
    this.billExportService.getBillExportSynthetic(
  ...
  drawTable() {
    ...
    if (this.table) {
      ...
      this.table = new Tabulator('#table_BillExportSynthetic', {
        ...
        columns: [
          { title: "STT", formatter: "rownum", hozAlign: "center", width: 60, headerSort: false,frozen: true },
          { title: 'Nhận chứng từ', field: 'IsApproved', hozAlign: 'center',  headerHozAlign: 'center',
          ...
          { title: 'Trạng Thái', field: 'nameStatus', hozAlign: 'left', headerHozAlign: 'center',frozen: true, },
          { 
          ...
          { title: 'Mã NCC', field: 'CodeNCC', hozAlign: 'left', headerHozAlign: 'center' },
          ...
          { title: 'Loại vật tư', field: 'ProductTypeText', hozAlign: 'left', headerHozAlign: 'center' },
          { title: 'Kho', field: 'WarehouseName', hozAlign: 'left', headerHozAlign: 'center' },
          { title: 'Loại phiếu', field: 'nameStatus', hozAlign: 'left', headerHozAlign: 'center' },
          ...
          { title: 'SerialNumber', field: 'SerialNumber', hozAlign: 'left', headerHozAlign: 'center', editor: 'input' },
          { title: 'Ghi chú', field: 'Note', hozAlign: 'left', headerHozAlign: 'center', editor: 'input' },
        ]
      });
    }
  }
