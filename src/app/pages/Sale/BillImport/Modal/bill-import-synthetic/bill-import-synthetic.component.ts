...
//
  ...
  loadDataBillImportSynthetic() {
    ...
    this.billImportService.getBillImportSynthetic(
  ...
  UpdateDocument() {
    this.billImportService.updateDocument(this.data).subscribe({
      next: (res) => {
        if (res.status == 1 ) {
          this.notification.success("Thông báo", res.message || "Cập nhật thành công")
          this.drawTable();
  ...
  drawTable() {
    ...
    this.table = new Tabulator('#table_BillImportSynthetic', {
      ...
      columns: [
        ...
        { title: "Ngày nhận", field: "CreatedDate", hozAlign: "center", width: 120,frozen: true, 
            formatter: (cell) => {
          const value = cell.getValue();
          return value ? DateTime.fromISO(value).toFormat('dd/MM/yyyy') : '';
        }, },
        { title: "Loại phiếu", field: "BillTypeText", width: 120,frozen: true, },
        { title: "Ngày Y/c nhập", field: "DateRequestImport", width: 130, frozen: true,
           formatter: (cell) => {
          const value = cell.getValue();
          return value ? DateTime.fromISO(value).toFormat('dd/MM/yyyy') : '';
        }, },
        { title: "Số phiếu", field: "BillImportCode", width: 160,bottomCalc: "count",frozen: true, },
        ...
        { title: "Ngày tạo", field: "CreatedDate", hozAlign: "center", width: 120,  
           formatter: (cell) => {
          const value = cell.getValue();
          return value ? DateTime.fromISO(value).toFormat('dd/MM/yyyy') : '';
        }, },
        ...
        { title: "Ngày hóa đơn", field: "DateSomeBill", width: 150,   
          formatter: (cell) => {
          const value = cell.getValue();
          return value ? DateTime.fromISO(value).toFormat('dd/MM/yyyy') : '';
        },
        ...
        { title: "Trạng thái chứng từ", field: "IsSuccessText",  width:250,
          formatter: "textarea",
          formatterParams: {
          maxHeight: 250 },
        },
        { title: "PO", field: "BillCodePO", width:250,
          formatter: "textarea",
          formatterParams: {
          maxHeight: 250 }, },
        { title: "Biên bản bàn giao", field: "D1", width:250,
          formatter: "textarea",
          formatterParams: {
          maxHeight: 250 }, },
        { title: "Phiếu Xuất Kho", field: "D2", width:250,
          formatter: "textarea",
          formatterParams: {
          maxHeight: 250 }, },
        { title: "Chứng Nhận Xuất xứ", field: "D3", width:250,
          formatter: "textarea",
          formatterParams: {
          maxHeight: 250 }, },
        { title: "Chứng nhận chất lượng", field: "D5", width:250,
          formatter: "textarea",
          formatterParams: {
          maxHeight: 250 }, },
      ],
