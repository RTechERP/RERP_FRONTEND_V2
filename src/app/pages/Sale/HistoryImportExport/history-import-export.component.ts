...
export class HistoryImportExportComponent implements OnInit, AfterViewInit {
  ...
  sizeSearch: string = '0';
  searchParams = {
    dateStart: new Date(new Date().setDate(new Date().getDate() -2)).toISOString().split('T')[0],
  ...
  loadData() {
    ...
    this.historyImportExportService.getHistoryImportExport(
  ...
  drawTable() {
    this.table = new Tabulator("#table_HistoryImportExport", {
      ...
      columns: [
        ...
        { title: 'Tình trạng chứng từ', field: 'ApproveText', hozAlign: 'center', headerHozAlign: 'center' },
        { title: 'Ngày huỷ/nhận chứng từ', field: 'DateStatus', hozAlign: 'center', headerHozAlign: 'center', formatter: (cell) => {
          const value = cell.getValue();
          return value ? DateTime.fromISO(value).toFormat('dd/MM/yyyy') : '';
        }, },
        { title: 'Số phiếu', field: 'Code', hozAlign: 'left', headerHozAlign: 'center',},
        { title: 'Nhà cung cấp', field: 'SupplierName', hozAlign: 'left', headerHozAlign: 'center' },
        { title: 'Ngày tạo', field: 'CreatDate', hozAlign: 'center', headerHozAlign: 'center', formatter: (cell) => {
          const value = cell.getValue();
          return value ? DateTime.fromISO(value).toFormat('dd/MM/yyyy') : '';
        }, },
        ...
        { title: 'Ngày xuất', field: 'DateStatus', hozAlign: 'center', headerHozAlign: 'center', formatter: (cell) => {
          const value = cell.getValue();
          return value ? DateTime.fromISO(value).toFormat('dd/MM/yyyy') : '';
        }, },
        ...
        { title: 'Hoá đơn', field: 'InvoiceNumber', hozAlign: 'left', headerHozAlign: 'center' },
        { title: 'Đơn mua hàng', field: 'PurchaseOrder', hozAlign: 'left', headerHozAlign: 'center' },
        { title: 'Dự án', field: 'ProjectName', hozAlign: 'left', headerHozAlign: 'center' },
        { title: 'Ghi chú', field: 'Note', hozAlign: 'left', headerHozAlign: 'center' },
        { title: 'Người xuất', field: 'FullName', hozAlign: 'left', headerHozAlign: 'center' },
        { title: 'Người nhập', field: 'FullName1', hozAlign: 'left', headerHozAlign: 'center' },
        { title: 'Loại vật tư', field: 'MaterialType', hozAlign: 'left', headerHozAlign: 'center' },
