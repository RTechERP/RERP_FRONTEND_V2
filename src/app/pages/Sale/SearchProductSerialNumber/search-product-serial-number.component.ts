...
export class SearchProductSerialNumberComponent implements OnInit, AfterViewInit {
  constructor(
  ...
  drawTable() {
    this.table_Import = new Tabulator('#table_import', {
      ...
      columns: [
        ...
        { title: "Mã phiếu nhập", field: "BillImportCode", hozAlign: "left", headerHozAlign: "center", width: 80, },
        ...
        { title: "Mã theo dự án", field: "ProjectName", hozAlign: "left", headerHozAlign: "center" },
