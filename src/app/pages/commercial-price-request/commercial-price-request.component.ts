...
export class CommercialPriceRequestComponent implements OnInit {
  ...
  filter = {
    ...
    PageNumber: 1,
    PageSize: 99999999 // Gọi tất cả dữ liệu 1 lần
  };
  ...
  initMenuBar(): void {
    this.menuBars = [
      ...
      // },
      {
        ...
        visible: this.appUserService.hasPermission('N35')
      },
    ];
  }
  ...
  getData(): void {
    ...
    this.commercialPriceRequestService.getCommercialPriceRequests(this.filter).subscribe({
      next: (res: any) => {
