...
export class CourseExamPracticeWebComponent implements OnInit, AfterViewInit {
    ...
    this.service.getCourseNew().subscribe(
      (response) => {
        ...
        if (response && response.status === 1) {
          ...
          console.log('[Parent] loadAllCoursesNew — allCourseNewData length:', this.allCourseNewData.length);
        } else {
