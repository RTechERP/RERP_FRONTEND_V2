...
export class DailyReportMarComponent implements OnInit, AfterViewInit {
  @ViewChild('tb_daily_report_mar', { static: false })
  tb_daily_report_marContainer!: ElementRef;
  ...
  ngAfterViewInit(): void {
    this.drawTbDailyReportMar(this.tb_daily_report_marContainer.nativeElement);
  }
  ...
  drawTbDailyReportMar(container: HTMLElement): void {
    if (this.tb_daily_report_mar) {
      this.tb_daily_report_mar.setData(this.dailyReportHrData);
    } else {
      this.tb_daily_report_mar = new Tabulator(container, {
  ...
  editDailyReport(): void {
    const selectedRows = this.tb_daily_report_mar.getSelectedData();
  ...
  async exportReport(): Promise<void> {
    const table = this.tb_daily_report_mar;
    if (!table) {
