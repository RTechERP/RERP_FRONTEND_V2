import { Component, OnInit, AfterViewInit, ViewChild, ElementRef, HostListener, Optional, Inject } from '@angular/core';
            ...
            if (res && res.status === 1 && res.data) {
                ...
                this.loadDepartments(() => {
                    ...
                    if (this.currentUser.IsAdmin == true || this.currentUser.Permissions?.includes('N1')) {
                        // console.log('this.departmentId:', this.departmentId, typeof (this.departmentId));
