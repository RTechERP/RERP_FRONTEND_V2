  ...
  initDataTable(): void {
    this.dataTable = new Tabulator(this.viewPOKHTableElement.nativeElement, {
      ...
      columns: [
        ...
        { title: 'New Account', field: 'New Account', sorter: 'number', width: 100,},
        { title: 'Số POKH', field: 'PONumber', sorter: 'number', width: 100,},
        { title: 'Mã PO', field: 'POCode', sorter: 'number', width: 100,},
        { title: 'Khách hàng', field: 'CustomerName', sorter: 'number', width: 100,},
        { title: 'Người phụ trách', field: 'FullName', sorter: 'number', width: 100,},
        { title: 'Dự Án', field: 'ProjectName', sorter: 'number', width: 100,},
        { title: 'Ngày nhận PO', field: 'ReceivedDatePO', sorter: 'number', width: 100,},
        { title: 'Loại tiền', field: 'CurrencyCode', sorter: 'number', width: 100,},
        { title: 'Tổng tiền nhận PO', field: 'TotalMoneyPO', sorter: 'number', width: 100,},
        { title: 'Tổng tiền trước VAT', field: 'TotalMoneyKoVAT', sorter: 'number', width: 100,},
        { title: 'Tiền về', field: 'ReceiveMoney', sorter: 'number', width: 100,},
        { title: 'Tình trạng tiến độ giao hàng', field: 'DeliveryStatusText', sorter: 'number', width: 100,},
        { title: 'Tình trạng xuất kho', field: 'ExportStatusText', sorter: 'number', width: 100,},
        ...
        { title: 'Hóa đơn', field: 'ImportStatusText', sorter: 'number', width: 100,},
        ...
        { title: 'SL đã nhập', field: 'QuantityReturn', sorter: 'number', width: 100,},
        ...
        { title: 'Kích thước phim cắt/Model', field: 'FilmSize', sorter: 'number', width: 100,},
        { title: 'ĐVT', field: 'Unit', sorter: 'number', width: 100,},
        { title: 'Đơn giá trước VAT', field: 'UnitPrice', sorter: 'number', width: 100,},
        { title: 'Tổng tiền trước VAT', field: 'IntoMoney', sorter: 'number', width: 100,},
        { title: 'VAT%', field: 'VAT', sorter: 'number', width: 100,},
        { title: 'Tổng tiền sau VAT', field: 'TotalPriceIncludeVAT', sorter: 'number', width: 100,},
        { title: 'Người nhận', field: 'UserReceiver', sorter: 'number', width: 100,},
        { title: 'Ngày yêu cầu giao hàng', field: 'DeliveryRequestedDate', sorter: 'number', width: 100,},
        ...
        { title: 'Công nợ', field: 'Debt', sorter: 'number', width: 100,},
        { title: 'Ngày yêu cầu thanh toán', field: 'PayDate', sorter: 'number', width: 100,},
        { title: 'Ngày giao hàng', field: 'ActualDeliveryDate', sorter: 'number', width: 100,},
