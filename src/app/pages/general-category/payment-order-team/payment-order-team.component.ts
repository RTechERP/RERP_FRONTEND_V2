...
import {
  PaymentOrder,
  PaymentOrderDetailField,
  PaymentOrderField,
} from '../payment-order/model/payment-order';
...
import { PaymentOrderTypeService } from '../payment-order/payment-order-type/payment-order-type.service';

import pdfMake from 'pdfmake/build/pdfmake';
import vfs from '../../../shared/pdf/vfs_fonts_custom.js';
import { NzIconModule } from 'ng-zorro-antd/icon';
import { PaymentOrderSpecialComponent } from '../payment-order/payment-order-special/payment-order-special.component';
...
@Component({
  selector: 'app-payment-order-team',
  imports: [
    CommonModule,
    Menubar,
    NzSplitterModule,
  ...
  templateUrl: './payment-order-team.component.html',
  styleUrls: ['./payment-order-team.component.css'],
  standalone: true,
})
export class PaymentOrderTeamComponent implements OnInit {
  menuBars: MenuItem[] = [];
  param: any = {
    pageNumber: 1,
    pageSize: 999999999,
  ...
  ngOnInit()  {
    ...
    this.isPermisstion =
      this.appUserService.currentUser?.Permissions.includes(
        permissionCodeTBP,
      ) ||
    ...
    // }
    this.param.approvedTBPID = 0;
    this.employeeId = this.appUserService.currentUser?.EmployeeID!;
    this.param.employeeID = 0;
    // this.initMenuBar();
    this.initGrid();
  ...
  initMenuBar() {
    this.menuBars = [
      ...
      },
      {
        ...
        command: () => {
          this.onApprovedTBP(2, {
            ButtonActionGroup: 'btnTBP',
            ButtonActionName: 'btnUnApproveTBP',
            ButtonActionText: 'Trưởng bộ phận',
          });
        },
      },
        ...
        items: [
          {
            ...
            command: () => {
              this.onApprovedHR(1, {
                ButtonActionGroup: 'btnHR',
                ButtonActionName: 'btnApproveDocumentHR',
                ButtonActionText: 'HR xác nhận',
              });
            },
          },
          {
            ...
            command: () => {
              this.onApprovedHR(2, {
                ButtonActionGroup: 'btnHR',
                ButtonActionName: 'btnUnApproveDocumentHR',
                ButtonActionText: 'HR xác nhận',
              });
            },
          },

          {
            ...
            command: () => {
              this.onApprovedHR(3, {
                ButtonActionGroup: 'btnHR',
                ButtonActionName: 'btnHRUpdateDocument',
                ButtonActionText: 'HR xác nhận',
              });
            },
          },
          ...
          },
          {
            ...
            command: () => {
              this.onApprovedHR(2, {
                ButtonActionGroup: 'btnHR',
                ButtonActionName: 'btnUnApproveHR',
                ButtonActionText: 'HR xác nhận',
              });
            },
          },
        ...
        items: [
          {
            ...
            command: () => {
              this.onApprovedKTTT(1, {
                ButtonActionGroup: 'btnKTTT',
                ButtonActionName: 'btnApproveDocument',
                ButtonActionText: 'Kế toán xác nhận',
              });
            },
          },
          {
            ...
            command: () => {
              this.onApprovedKTTT(3, {
                ButtonActionGroup: 'btnKTTT',
                ButtonActionName: 'btnUpdateDocument',
                ButtonActionText: 'Kế toán xác nhận',
              });
            },
          },
          {
            ...
            command: () => {
              this.onApprovedKTTT(2, {
                ButtonActionGroup: 'btnKTTT',
                ButtonActionName: 'btnUnApproveDocument',
                ButtonActionText: 'Kế toán xác nhận',
              });
            },
          },
          ...
          },
          {
            ...
            command: () => {
              this.onApprovedKTT(1, {
                ButtonActionGroup: 'btnKTT',
                ButtonActionName: 'btnApproveKT',
                ButtonActionText: 'Kế toán xác nhận',
              });
            },
          },
          {
            ...
            command: () => {
              this.onApprovedKTT(2, {
                ButtonActionGroup: 'btnKTT',
                ButtonActionName: 'btnUnApproveKT',
                ButtonActionText: 'Kế toán xác nhận',
              });
            },
          },
...

          {
            ...
            command: () => {
              this.onApprovedKTTT(1, {
                ButtonActionGroup: 'btnKTTT',
                ButtonActionName: 'btnReceiveDocument',
                ButtonActionText: 'Kế toán xác nhận',
              });
            },
          },
          {
            ...
            command: () => {
              this.onApprovedKTTT(2, {
                ButtonActionGroup: 'btnKTTT',
                ButtonActionName: 'btnUnReceiveDocument',
                ButtonActionText: 'Kế toán xác nhận',
              });
            },
          },
...

      {
        ...
        command: () => {
          this.onApprovedBGD(1, {
            ButtonActionGroup: 'btnBGĐ',
            ButtonActionName: 'btnApproveBGĐ',
            ButtonActionText: 'BGĐ xác nhận',
          });
        },
      },
      {
        ...
        command: () => {
          this.onApprovedBGD(2, {
            ButtonActionGroup: 'btnBGĐ',
            ButtonActionName: 'btnUnApproveBGĐ',
            ButtonActionText: 'BGĐ xác nhận',
          });
        },
      },
...

      {
        ...
        command: () => {
          ...
          if (activeCell) {
            ...
            const url =
              environment.host + 'api/share/Accountant/2.NỘI BỘ' + pathPattern;
      ...
      },
      {
        ...
        command: () => {
          const dateStart = DateTime.fromJSDate(this.param.dateStart).toFormat(
            'ddMMyyyy',
          );
          const dateEnd = DateTime.fromJSDate(this.param.dateEnd).toFormat(
            'ddMMyyyy',
          );
        ...
        commandItems: [
          {
            command: '',
            title: 'Bổ sung file',
            iconCssClass: 'fa-solid fa-paperclip',
            positionOrder: 1,
            action: (e, args) => {
            ...
            action: (e, args) => {
              ...
              if (pathFolder == '') {
                this.notification.warning(
                  ...
                  `Không tìm thấy đường dẫn cho hợp đồng số [${documentName}]`,
                );
              } else {
                pathFolder = pathFolder.replace(
                  '\\\\192.168.1.190\\File Scan HĐ\\',
                  'api/share/FileScanHD/',
                );
                // pathFolder = pathFolder.replace('\', '/');
        ...
        commandItems: [
          {
            ...
            action: (e, args) => {
              ...
              if (filePath) {
                ...
                let urlImg =
                  filePath.replace('\\\\192.168.1.190', host) +
                  `/${args.dataContext?.FileName}`;
...

          {
            ...
            positionOrder: 62,
            action: (e, args) =>
              this.onDownloadFileAttach(e, args, this.angularGridFile),
            //         (e, args) => {
      ...
      contextMenu: {
        ...
        commandItems: [
...

          {
            ...
            positionOrder: 62,
            action: (e, args) =>
              this.onDownloadFileAttach(e, args, this.angularGridFileBankslip),
            // action: (e, args) => {
            //     let selectedItems = args.grid.getSelectedRows()
  ...
  async loadSteps() {
    const res = await firstValueFrom(this.paymentService.getStep());

    const followType = this.activeTab == '0' ? 1 : 3;

    this.steps = res.data
      .filter((x: any) => x.FollowType == followType && x.Step != 1)
      .map((x: any) => ({
        value: x.Step,
  ...
  async loadDataCombo() {
     // 👉 cái này chạy ngay lập tức (không phụ thuộc API)
    this.isApproveds = [
    ...
    try {
      const res = await firstValueFrom(
        forkJoin({
          ...
          teams: this.paymentService.getTeamSale(this.employeeId),
          orderTypes: this.paymentOrderTypeService.getAll(),
          //steps: this.paymentService.getStep(),
        }),
      );
      ...
      // 2. Teams
      this.employeeTeams = res.teams.data;

      const map = new Map<string, any[]>();
      res.teams.data.forEach((e: any) => {
        if (!map.has(e.TeamName)) {
          map.set(e.TeamName, []);
        }
        map.get(e.TeamName)!.push(e);
      });

      this.employees = Array.from(map.entries()).map(([TeamName, items]) => ({
        TeamName,
        items,
      }));

      // 3. Order Types
      this.paymentOrderTypes = res.orderTypes.data;
  ...
  loadData() {
    ...
    // if(!this.param.step || this.param.step == 0) {
    //   this.param.step = 2;
    // }
    this.loadDataNormal();
  ...
  loadDataNormal() {
    this.isLoading = true;
    const { employeeID, ...restParam } = this.param;

    let listEmployeeID = this.employeeTeams
      .map((x: any) => x.EmployeeID)
      .join(',');

    if (this.param.employeeID && this.param.employeeID > 0) {
      listEmployeeID = String(this.param.employeeID);
    }
    ...
    this.paymentService.getPaymentOrderByTeam(p).subscribe({
      next: (response) => {
  ...
  onDelete() {
    ...
    let selectedItems = rowIndexes.map((i) => dataView.getItem(i));
  ...
  onCopy() {
    ...
    if (activeCell) {
      ...
      item.DepartmentName =
        this.appUserService.currentUser?.DepartmentName || '';
      item.Code = '';
  ...
  async onApprovedKTTT(isApproved: number, action: any) {
    ...
    if (isApproved == 1) {
      if (
        action.ButtonActionName == 'btnApproveDocument' ||
        action.ButtonActionName == 'btnApproveKT'
      ) {
        ...
        selectedItems = selectedItems.map((x, i) => ({
          ...
          PaymentOrderLog: {
            ...
            IsRequestAppendFileAC:
              action.ButtonActionName == 'btnUpdateDocument',
          },
        }));
  ...
  async onAttachFileBankslip() {
    ...
    if (activeCell) {
      ...
      if (files && files.length > 0) {
        ...
        this.paymentService
          .uploadFileBankslip(files, item.ID.toString())
          .subscribe({
            next: (response) => {
              this.loadDetail(item.ID);
            },
  ...
  async onAttachFileExtend() {
    ...
    if (activeCell) {
      ...
      if (files && files.length > 0) {
        ...
        this.paymentService
          .uploadFile(files, item.ID, JSON.stringify(fileDeletes))
          .subscribe({
            next: (reponse) => {
              // console.log(reponse);
  ...
  drawPDF(dataPrint: any) {
    ...
    const numberDocument =
      paymentOrder.TypeOrder == 1 ? 'BM01-RTC.AC-QT03' : 'BM02-RTC.AC-QT03';
    ...
    if (paymentOrder.TypeOrder == 1) {
        ...
        table: {
          ...
          body: [
            [
              ...
              {
                colSpan: 3,
                text: `:Ngày ${datePayment.getDate()} tháng ${datePayment.getMonth() + 1} năm ${datePayment.getFullYear()}`,
              },
            ],
          ],
        },
      ...
      let totalQuantity = details.reduce(
        (sum: number, x: any) => sum + x.Quantity,
        0,
      );
      totalQuantity = totalQuantity == 0 ? '' : totalQuantity;

      let totalUnitPrice = details.reduce(
        (sum: number, x: any) => sum + x.UnitPrice,
        0,
      );
      totalUnitPrice =
        totalUnitPrice == 0
          ? ''
          : isVND
            ? this.formatNumber(totalUnitPrice, 0)
            : this.formatNumber(totalUnitPrice);

      let totalMoney = details.reduce(
        (sum: number, x: any) => sum + x.TotalMoney,
        0,
      );
      totalMoney =
        totalMoney == 0
          ? ''
          : isVND
            ? this.formatNumber(totalMoney, 0)
            : this.formatNumber(totalMoney);
    ...
    for (let i = 0; i < details.length; i++) {
      ...
      const quantity =
        detail.Quantity == 0 ? '' : this.formatNumber(detail.Quantity);
      const unitPrice =
        detail.UnitPrice == 0
          ? ''
          : isVND
            ? this.formatNumber(detail.UnitPrice, 0)
            : this.formatNumber(detail.UnitPrice);
      const totalMoney =
        detail.TotalMoney == 0
          ? ''
          : isVND
            ? this.formatNumber(detail.TotalMoney, 0)
            : this.formatNumber(detail.TotalMoney);
      const paymentPercentage =
        detail.PaymentPercentage == 0 ? '' : detail.PaymentPercentage;
      const totalPaymentAmount =
        detail.TotalPaymentAmount == 0
          ? ''
          : isVND
            ? this.formatNumber(detail.TotalPaymentAmount, 0)
            : this.formatNumber(detail.TotalPaymentAmount);
      let item = [
    ...
    const dateApprovedEmp = signEmp?.DateApproved
      ? DateTime.fromISO(signEmp?.DateApproved).toFormat('dd/MM/yyyy HH:mm')
      : '';
    const dateApprovedTBP =
      (signTBP?.DateApproved || '') != ''
        ? DateTime.fromISO(signTBP?.DateApproved).toFormat('dd/MM/yyyy HH:mm')
        : '';
    const dateApprovedHR =
      (signHR?.DateApproved || '') != ''
        ? DateTime.fromISO(signHR?.DateApproved).toFormat('dd/MM/yyyy HH:mm')
        : '';
    const dateApprovedKT =
      (signKT?.DateApproved || '') != ''
        ? DateTime.fromISO(signKT?.DateApproved).toFormat('dd/MM/yyyy HH:mm')
        : '';
    const dateApprovedBGD =
      (signBGD?.DateApproved || '') != ''
        ? DateTime.fromISO(signBGD?.DateApproved).toFormat('dd/MM/yyyy HH:mm')
        : '';
    ...
    let docDefinition = {
      ...
      content: [
        ...
        {
          text: `GIẤY ${paymentOrder.TypeOrderText?.toUpperCase() ?? ''}`,
          bold: true,
          alignment: 'center',
        },
            ...
            body: [
              ...
              [
                ...
                },
                {
                  colSpan: 2,
                  text:
                    paymentOrder.TypePayment == 2
                      ? '[x] Tiền mặt'
                      : '[ ] Tiền mặt',
                },
              ],
              [
                { text: '- Số tài khoản', margin: [15, 0, 0, 0] },
                { text: `:${paymentOrder.AccountNumber}` },
                'Ngân hàng',
                `:${paymentOrder.Bank}`,
              ],
            ],
          ...
          table: {
            ...
            body: [
              [
                {
                  colSpan: 3,
                  text: '5. Số tiền đề nghị được ghi theo bảng kê dưới đây:',
                },
                {},
                {},
                { text: 'ĐVT:' },
          ...
          table: {
            ...
            body: [
              ...
              [
                {
                  colSpan: 9,
                  text: `Số tiền bằng chữ: ${paymentOrder.TotalMoneyText}`,
                  bold: true,
                  italics: true,
                },
              ],
        ...
        {
          text: paymentOrder.AccountingNote,
          bold: true,
          margin: [0, 0, 0, 60],
        },
  ...
  drawPDFSpecial(dataPrint: any) {
    ...
    const dateOrder = new Date(paymentOrder.DateOrder);
    const datePayment =
      (paymentOrder.DatePayment || '') == ''
        ? ''
        : DateTime.fromISO(paymentOrder.DatePayment).toFormat('dd/MM/yyyy');
    ...
    const isVND = (paymentOrder.Unit?.toUpperCase() ?? '') == 'VND';
    let totalMoneys = details.reduce(
      (sum: number, x: any) => sum + x.TotalMoney,
      0,
    );
    totalMoneys =
      totalMoneys == 0
        ? ''
        : isVND
          ? this.formatNumber(totalMoneys, 0)
          : this.formatNumber(totalMoneys);
          ...
          table: {
            ...
            body: [
              [
                {
                  colSpan: 3,
                  text: '4. Số tiền đề nghị được ghi theo bảng kê dưới đây:',
                },
                {},
                {},
                { text: 'ĐVT:' },
  ...
  onDownloadFileAttach(e: Event, args: any, angularGrid: AngularGridInstance) {
    ...
    let selectedItems = selectedRows.map((i: any) =>
      angularGrid.dataView?.getItem(i),
    );
    ...
    selectedItems.forEach((item: any) => {
      ...
      if (filePath) {
        const host = environment.host + 'api/share';
        let url =
          filePath.replace('\\\\192.168.1.190', host) + `/${item?.FileName}`;
  ...
  onUpdateTotalMoney() {
    ...
    selectedItems = selectedItems.map((x, i) => ({
      ...
      TotalMoneyText: this.paymentService.readMoney(
        x.TotalPaymentActual != 0 ? x.TotalPaymentActual : x.TotalPayment,
        x.Unit,
      ),
      TotalMoney:
        x.TotalPaymentActual != 0 ? x.TotalPaymentActual : x.TotalPayment,
