...
@Component({
  ...
  styleUrl: './asset-log.component.css'
})
export class AssetLogComponent implements OnInit, OnChanges {
  ...
  constructor(private assetsManagementService: AssetsManagementService) { }
