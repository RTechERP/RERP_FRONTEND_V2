...
@Component({
  selector: 'app-contract-transfer-review-bgd',
  standalone: true,
  imports: [
  ...
  templateUrl: './contract-transfer-review-bgd.component.html',
  styleUrl: './contract-transfer-review-bgd.component.css'
})
export class ContractTransferReviewBgdComponent implements OnInit, OnDestroy {
  ...
  checkRole(): string {
    if (this.permissionService.hasPermission('N1')) {
      return 'bgd';
    }
    return '';
  }
  ...
  get rowActionBtn(): { label: string; icon: string; nzType: string } {
    return { label: 'Xem đánh giá', icon: 'eye', nzType: 'default' };
  }
