...
@Component({
  selector: 'app-early-late-person',
  imports: [
    CommonModule,
    NzModalModule,
    NzIconModule,
  ...
  styleUrl: './early-late-person.component.css'
})
export class EarlyLatePersonComponent implements OnInit, AfterViewInit, OnDestroy {
  sizeSearch: string = '0';
  ...
  loadEarlyLate() {
    ...
    this.earlyLateService.getEmployeeEarlyLatePersonal(request).subscribe({
      next: (data) => {
