...
export class EmployeeContactComponent implements OnInit, AfterViewInit {
    ...
    private initGrid(): void {
        ...
        this.columnDefinitions = [
            {
                id: 'STT', name: 'STT', field: 'STT', width: 80, sortable: true, filterable: true,
                type: 'number',
            ...
            {
                id: 'StartWorking', name: 'Ngày vào', field: 'StartWorking', width: 100, sortable: true, type: 'date',
                filter: { model: Filters['compoundDate'] },
                formatter: Formatters.date, params: { dateFormat: 'DD/MM/YYYY' }, filterable: true, cssClass: 'text-center'
            },
            {
                id: 'BirthOfDate', name: 'Năm sinh', field: 'BirthOfDate', width: 90, sortable: true, type: 'number',
                filter: { model: Filters['compoundInputNumber'] },
                formatter: Formatters.date, params: { dateFormat: 'YYYY' }, filterable: true, cssClass: 'text-center'
            },
        ];
