...
export class EmployeeImportExcelComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  drawtable() {
    ...
    this.tableExcel = new Tabulator('#datatableExcel', {
      ...
      columns: [
        ...
        { title: 'Mã nhân viên', field: 'Code', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'ID Chấm công', field: 'IDChamCongMoi', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Họ và tên', field: 'FullName', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 150 },
        { title: 'Phòng ban', field: 'DepartmentName', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Chức vụ (HĐLĐ)', field: 'ChucVuHD', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 150 },
        { title: 'Chức vụ (Nội bộ)', field: 'ChucVu', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 150 },
        { title: 'Đơn vị BHXH', field: 'DvBHXH', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Ngày bắt đầu làm việc', field: 'DateStartContract', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Ngày sinh', field: 'BirthOfDate', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Nơi sinh', field: 'NoiSinh', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Giới tính', field: 'GioiTinh', hozAlign: 'center', headerHozAlign: 'center', headerWordWrap: true, width: 80 },
        { title: 'Dân tộc', field: 'DanToc', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Tôn giáo', field: 'TonGiao', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Quốc tịch', field: 'QuocTich', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Tình trạng hôn nhân', field: 'TinhTrangHonNhan', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Địa điểm làm việc', field: 'DiaDiemLamViec', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'SĐT cá nhân', field: 'SDTCaNhan', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Email cá nhân', field: 'EmailCaNhan', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 150 },
        { title: 'SĐT công ty', field: 'SDTCongTy', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Email công ty', field: 'EmailCongTy', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 150 },
        { title: 'CMND/CCCD', field: 'CMTND', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Ngày cấp', field: 'NgayCap', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Nơi cấp', field: 'NoiCap', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Địa chỉ thường trú', field: 'DcThuongTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 150 },
        { title: 'Tỉnh/TP thường trú', field: 'TinhTPThuongTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Quận/Huyện thường trú', field: 'QuanHuyenThuongTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Phường/Xã thường trú', field: 'PhuongXaThuongTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Đường thường trú', field: 'DuongThuongTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Số nhà thường trú', field: 'SoNhaThuongTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Địa chỉ tạm trú', field: 'DcTamTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 150 },
        { title: 'Tỉnh/TP tạm trú', field: 'TinhTPTamTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Quận/Huyện tạm trú', field: 'QuanHuyenTamTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Phường/Xã tạm trú', field: 'PhuongXaTamTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Đường tạm trú', field: 'DuongTamTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Số nhà tạm trú', field: 'SoNhaTamTru', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Số sổ BHXH', field: 'SoSoBHXH', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Người giữ sổ BHXH', field: 'NguoiGiuSoBHXH', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Ngày bắt đầu đóng BHXH', field: 'NgayBatDauBHXH', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Mức đóng BHXH hiện tại', field: 'MucDongBHXHHienTai', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 120 },
        { title: 'Giảm trừ bản thân', field: 'GiamTruBanThan', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Số người phụ thuộc', field: 'SoNguoiPT', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Tổng tiền giảm trừ', field: 'TongTien', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'MST cá nhân', field: 'MST', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'STK chuyển lương', field: 'STKChuyenLuong', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Lương thử việc', field: 'LuongThuViec', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Lương cơ bản', field: 'LuongCoBan', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Phụ cấp ăn ca', field: 'AnCa', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Phụ cấp xăng xe', field: 'XangXe', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Phụ cấp điện thoại', field: 'DienThoai', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Phụ cấp nhà ở', field: 'NhaO', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Phụ cấp trang phục', field: 'TrangPhuc', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Phụ cấp chuyên cần', field: 'ChuyenCan', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Phụ cấp khác', field: 'Khac', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Tổng phụ cấp', field: 'TongPhuCap', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Tổng lương', field: 'TongLuong', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Tình trạng', field: 'TinhTrang', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'SYLL', field: 'SYLL', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Giấy KS', field: 'GiayKS', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'CMND/CCCD (Checklist)', field: 'CMNDorCCCD', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Sổ HK', field: 'SoHK', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Giấy KSK', field: 'GiayKSK', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'XNNS', field: 'XNNS', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Bằng cấp', field: 'BangCap', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'CV', field: 'CV', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'ĐXV', field: 'DXV', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Cam kết tài sản', field: 'CamKetTs', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Tờ trình tuyển dụng', field: 'ToTrinhTD', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Thư mời nhận việc', field: 'ThuMoiNhanViec', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Quyết định tuyển dụng', field: 'QDTD', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Hợp đồng thử việc', field: 'HDTV', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Đánh giá thử việc', field: 'DGTV', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'HDLD KXDTH(12T-36T)', field: 'HDLDXDTH', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'Đánh giá chuyển hợp đồng', field: 'DGChuyenHD', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },
        { title: 'HDLDKXDTH', field: 'HDLDKXDTH', hozAlign: 'left', headerHozAlign: 'center', headerWordWrap: true, width: 100 },

      ]

    });
    this.tableExcel.on("pageLoaded", () => {
      this.tableExcel.redraw();
    });
