...
@Component({
  selector: 'app-job-requirement-personal',
  imports: [
    CommonModule,
    NzCardModule,
    FormsModule,
  ...
  styleUrl: './job-requirement-personal.component.css',
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class JobRequirementPersonalComponent {
  ...
  getCurrentUser(): void {
    this.authService.getCurrentUser().subscribe({
      next: (res: any) => {
        ...
        if (this.currentUser) {
          this.searchParams.EmployeeID = this.currentUser.EmployeeID || 0;
          this.searchParams.DepartmentID = this.currentUser.DepartmentID || 0;
        }
  ...
  getJobrequirement(): void {
    ...
    this.JobRequirementService.getJobrequirementPersonal(
