...
export class RecommendSupplierFormComponent implements OnInit, AfterViewInit {
  ...
  loadJobRequirementDetail(JobrequirementID: number) {
    ...
    const master$ = this.recommendSupplierService.getJobrequirement(
      this.DepartmentID,
      this.EmployeeID,
      this.Step,
      this.ApprovedTBPID,
    ...
    const detail$ =
      this.recommendSupplierService.getJobrequirementbyID(JobrequirementID);
  ...
  loadDepartmentRequiredData(JobrequirementID: number): void {
    this.recommendSupplierService.getDepartmentRequired(
  ...
  loadHCNSData(JobrequirementID: number): void {
    this.recommendSupplierService.getHCNSProposals(
      JobrequirementID,
