...
@Component({
  ...
  templateUrl: './recommend-supplier.component.html',
  styleUrl: './recommend-supplier.component.css',
})
export class RecommendSupplierComponent implements OnInit, AfterViewInit {
  ...
  getJobrequirement(): void {
    this.RecommendSupplierService.getJobrequirement(
  ...
  getJobrequirementbyID(id: number) {
    this.RecommendSupplierService.getJobrequirementbyID(id).subscribe(
      (response: any) => {
  ...
  getdataEmployee() {
    this.RecommendSupplierService.getAllEmployee().subscribe((response: any) => {
