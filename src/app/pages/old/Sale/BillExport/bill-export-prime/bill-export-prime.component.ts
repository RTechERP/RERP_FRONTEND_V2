...
@Component({
  selector: 'app-bill-export-prime',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './bill-export-prime.component.html',
  styleUrl: './bill-export-prime.component.css'
})
export class BillExportPrimeComponent {
  // ========================================
