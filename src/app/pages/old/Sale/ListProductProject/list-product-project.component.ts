...
export class ListProductProjectComponent implements OnInit, AfterViewInit {
    ...
    async exportExcel() {
        ...
        const worksheet = workbook.addWorksheet(
            `Danh sách sản phẩm theo dự án _${this.sreachParam.selectedProject?.ProjectCode || ''
            }`
        );
        ...
        link.download = `DanhSachSPTheoDuAn_${this.sreachParam.selectedProject?.ProjectCode || ''
            }.xlsx`;
