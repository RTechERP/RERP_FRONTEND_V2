...
@Component({
  standalone: true,
  imports: [FormsModule, CommonModule, NzButtonModule, NzIconModule, NzInputModule, NzGridModule, NzSpinModule],
  ...
  drawtable() {
    this.productTable = new Tabulator(this.table.nativeElement, {
          ...
          columns: [
            ...
            { title: "Ngày nhập", field: "CreateDate", sorter: "datetime", hozAlign: "center" },
            { title: "SL mượn", field: "BorrowCount", sorter: "number", hozAlign: "right" },
            { title: "Ngày mượn gần nhất", field: "MaxDateBorrow", sorter: "datetime", hozAlign: "center" },
            { title: "Mã sản phẩm", field: "ProductCode", sorter: "string", hozAlign: "left" },
            { title: "Tên", field: "ProductName", sorter: "string", hozAlign: "left" },
