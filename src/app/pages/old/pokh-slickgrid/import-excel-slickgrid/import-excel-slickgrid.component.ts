...
@Component({
  selector: 'app-import-excel-pokh-slickgrid',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  providers: [PokhSlickgridService],
  templateUrl: './import-excel-slickgrid.component.html',
  styleUrl: './import-excel-slickgrid.component.css'
})
export class ImportExcelPokhSlickgridComponent implements OnInit {
  sheetNames: string[] = [];
