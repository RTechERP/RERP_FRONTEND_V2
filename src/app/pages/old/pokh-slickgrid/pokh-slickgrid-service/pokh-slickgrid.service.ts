...
export class PokhSlickgridService {
  ...
  // New method for SlickGrid data loading
  getPOKHData(params: any): Observable<any> {
    return this.http.get<any>(this._url + 'get-pokh', { params });
  }
