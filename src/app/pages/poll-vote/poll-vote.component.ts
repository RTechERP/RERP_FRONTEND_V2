...
export class PollVoteComponent implements OnInit {
    ...
    get selectedPollBackgroundUrl(): string {
        return this.resolveBackgroundImageUrl(this.selectedPoll?.backgroundImagePath);
    }

    get selectedPollBackgroundStyle(): string | null {
        const url = this.selectedPollBackgroundUrl;
