...
@Component({
  selector: 'app-poncc-summary-new',
  standalone: true,
  imports: [
    CommonModule,
    AngularSlickgridModule,
  ...
  templateUrl: './poncc-summary-new.component.html',
  styleUrl: './poncc-summary-new.component.css'
})
export class PonccSummaryNewComponent {
  constructor(
  ...
  onSearch(): void {
    ...
    this.ponccService.getPONCCSummaryKT(request).subscribe({
      next: (response) => {
