...
export class PONCCComponent implements OnInit, AfterViewInit {
  ...
  onCreatePDFLanguageEn(data: any) {
    ...
    console.log('onCreatePDFLanguageEn data:', data);
      ...
      content: [
        {
          ...
          columns: [
            ...
            { text: po.POCode, fontSize: 12, alignment: 'center', bold: true },
          ],
        },
        {
          style: 'tableExample',
          table: {
            ...
            body: [
              ...
              [
                'Address:',
                { colSpan: 3, text: po.AddressNCC, bold: true },
                '',
                '',
                'No:',
                po.BillCode,
              ...
              [
                'Buyer:',
                { colSpan: 5, text: taxCompany.BuyerEnglish, bold: true },
              ],
              [
                'Address:',
