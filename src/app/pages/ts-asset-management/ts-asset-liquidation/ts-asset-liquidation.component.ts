...
@Component({
  ...
  selector: 'app-ts-asset-liquidation',
  templateUrl: './ts-asset-liquidation.component.html',
  styleUrls: ['./ts-asset-liquidation.component.css']
})
export class TsAssetLiquidationComponent implements OnInit, AfterViewInit {
