...
@Component({
    ...
    templateUrl: './custom-table-kpi.html',
    styleUrl: './custom-table-kpi.css',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class CustomTableKpi implements OnChanges, AfterViewInit, OnDestroy {
