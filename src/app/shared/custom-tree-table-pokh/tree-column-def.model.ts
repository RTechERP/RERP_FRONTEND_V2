...
export interface TreeColumnDef {
    ...
    sortable?: boolean;
    /** Custom sort logic for this column: (a, b) => number */
    sortComparer?: (value1: any, value2: any) => number;
    /** Freeze this column */
    frozen?: boolean;
    ...
    editType?: 'text' | 'number' | 'date' | 'lookup' | 'table-lookup' | 'textarea' | 'progressbar' | 'badge' | 'multiselect' | 'actions';
